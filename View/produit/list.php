...
<table>
    ...
    <?php foreach ($tab_p as $p) { ?>
        <tr>
            ...
            <td ><a href="index.php?action=update&controller=Produit&idProduit=<?php echo rawurlencode($p->get('idProduit'))?>&idCategorie=<?php echo rawurlencode($p->get('idCategorie'))?>">🖋</a></td>
            <td ><a href="index.php?action=delete&controller=Produit&idProduit=<?php echo rawurlencode($p->get('idProduit'))?>">❌</a></td>
        </tr>
    <?php } ?>
    </tbody>
</table>
